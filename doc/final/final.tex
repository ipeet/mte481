...
\begin{figure}[hbt]
 ...
 \caption{PCB Proof of Concept}\label{fig:test_joystick}
\end{figure}
...
\begin{figure}[hbt]
 ...
 \caption{CAD Model of Wheelchair}
\end{figure}
...
\begin{figure}[hbt]
 \centering
 \includegraphics[scale=0.6]{KINECT_RENDER}
...
\begin{figure}[hbt]
 ...
 \caption{Completed Wheelchair Collision Avoidance System}
...
\addcontentsline{toc}{chapter}{Appendix D - Selected Renders and Drawings}
\begin{figure}[hbt]
 \centering
 \includegraphics[scale=0.75]{BIG_RENDER}
\end{figure}
