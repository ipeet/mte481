...
The first patent (full patent number, author, and other details listed in \cite{patent:computer_controlled}), entitled \it{Computer Controlled Power Wheelchair Navigation System}, discusses a patent for wheelchair collision avoidance using cameras, proximity sensors, and microphones.
...
%\cite{patent:power_wheelchair}
%\cite{patent:wheelchair_method}
%\cite{patent:computer_controlled}
...
Based on NASA specifications for the 95th percentile male \cite{NASA} and female we can get what the dimension \it{a} should be. A should be at least 12.3cm to accommodate your basic 95th percentile male. To accommodate the 5th percentile male we need 12.0cm. This means that our current design should be as shown in Appendix \ref{mech_drawings}. Since our final design model has a height of 18.42 cm there we have a safety factor of 1.49.
...
\begin{tabular}{|l|c|c|c|}
\hline
Person & Size of Stomach/Chest & Distance to Kinect & Safety Factor (given dimensions shown in Appendix \ref{mech_drawings}) \\
