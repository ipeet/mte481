...
Based on NASA specifications for the 95th percentile male \ref{NASA} and female we can get what the dimension \it{a} should be. A should be at least 12.3cm to accommodate your basic 95th percentile male. To accommodate the 5th percentile male we need 12.0cm. This means that our current design should be as shown in Appendix \ref{app_mech}. Since our final design model has a height of 18.42 cm there we have a safety factor of 1.49.

The distance B would be important when the Kinect interferes with the person sitting in the chair. Again relying on the information from \ref{NASA} for 95th percentile male and 5th percentile female, we can construct the data shown in Table \ref{tab:anthro_data}.

\begin{figure}[h]
\centering
\begin{tabular}{|l|c|c|c|}
\hline
Person & Size of Stomach/Chest & Distance to Kinect & Safety Factor (given dimensions shown in Appendix \ref{app_mech}) \\
